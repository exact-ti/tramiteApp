...
class RecorridoProvider implements IRecorridoProvider {
  ...
  Future<List<EnvioModel>> enviosEntregaProvider(String codigo, int id) async {
    Response resp = await req.get('/servicio-tramite/recorridos/$id/areas/$codigo/envios/paraentrega');
    if(resp.data==""){
        return null;
    }
  ...
  @override
  Future<List<EnvioModel>> enviosRecojoProvider(String codigo, int recorridoId) async{

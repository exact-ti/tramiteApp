...
Future<bool> confirmarArray(BuildContext context, String tipo, String titulo, String descripcion,
    List<EnvioModel> novalidados) async {
        ...
        return AlertDialog(
          ...
          content: SingleChildScrollView(
            ...
            Container(
              child: Column(
                children: <Widget>[
                Container(child: Text(descripcion),
